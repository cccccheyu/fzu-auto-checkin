...
<details>
<summary><b>寒暑假怎么办？</b></summary>

内置了假期自动跳过：按《福州大学 2026—2027 学年校历》配置了寒假（1.23–2.21）和暑假（7.3–8.29）区间，假期内脚本**不签、不推、不留记录**，Actions 照常跑但等于空转。新学年校历发布后更新 `config.yaml` 的 `vacation.skip_ranges` 日期即可，也可以加自己的区间（如实训、离校期间）。
</details>
